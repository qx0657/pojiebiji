package com.qx.pjbj.checkupdate;
...
import com.qx.pjbj.checkupdate.download.A;
import com.qx.pjbj.checkupdate.download.DownLoadUtils;
            ...
            public void run() {
                ...
                try {
                    ...
                    if(jsonObject.getInt("newversioncode")> AppUtils.getAppVersionCode()){
                        ...
                        String filename = "破解笔记.ver."+newversionname+".apk";
                        final String apksavefilepath = AppConfig.APP_DIR + filename;
