...
public class MySpUtils {
    ...
    public static void SaveObjectData(String keyname, Object obj) {
        SharedPreferences sp = MyApplication.context.getSharedPreferences(MODE, Context.MODE_PRIVATE);// 创建对象
    ...
    public static <T> T getObjectData(String keyname) {
        SharedPreferences sp = MyApplication.context.getSharedPreferences(MODE, Context.MODE_PRIVATE);// 指定读取的对象
